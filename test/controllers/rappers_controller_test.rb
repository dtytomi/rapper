...
class RappersControllerTest < ActionController::TestCase
  ...
  test "should create rapper" do
    assert_difference('Rapper.count') do
      post :create, rapper: { album: @rapper.album, artist: @rapper.artist, description: @rapper.description, picture: @rapper.picture, song: @rapper.song }
    end
  ...
  test "should update rapper" do
    patch :update, id: @rapper, rapper: { album: @rapper.album, artist: @rapper.artist, description: @rapper.description, picture: @rapper.picture, song: @rapper.song }
    assert_redirected_to rapper_path(assigns(:rapper))
  end
